      ...
      <main className="pt-20">
        ...
        >
          ...
          >
            ...
            >
              Ascendant Auto Detailing offre un service d’esthétique automobile
              mobile haut de gamme à Montréal, incluant la Rive-Sud et la
              Rive-Nord. Que vous conduisiez un véhicule quotidien, une voiture
              de luxe ou une voiture haute performance, nous vous offrons une
              précision inégalée directement chez vous.
            </p>
            ...
            <div style={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
              <Link href="/fr/pricing">
                <button
                  style={{
                    background:
                      "linear-gradient(135deg, #d4af37, #f5d97a)",
                    color: "black",
                    padding: "14px 26px",
                    border: "none",
                    borderRadius: "6px",
        ...
        >
          ...
          <p style={{ color: "#ccc", lineHeight: "1.9", fontSize: "17px" }}>
            L’esthétique automobile est un processus minutieux de nettoyage,
            de restauration et de finition qui va bien au-delà d’un simple
            lavage de voiture. Chez Ascendant Auto Detailing, chaque surface
            est traitée avec précision à l’aide de produits haut de gamme et
            de techniques expertes.
          </p>
          ...
          >
            Nos services incluent le nettoyage intérieur en profondeur,
            l’extraction des taches, le traitement du cuir, la décontamination
            extérieure, le polissage et des protections conçues pour préserver
